...
one pasteable export command:

```bash
export STOREFRONT_URL=https://storefront-worker.jkahn-demo-2.workers.dev WORKFLOW_URL=https://rollout-workflow.jkahn-demo-2.workers.dev ACCOUNT_ID=e3a7330252222fac7058592f3add9100
```
